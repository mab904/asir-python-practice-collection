# Descripción
Este proyecto es un bot que utiliza OCR (Reconocimiento Óptico de Caracteres) usando Tesseract para leer texto directamente desde una zona específica de la pantalla.
...
# Description
This project is a bot that uses OCR (Optical Character Recognition) through Tesseract to read text directly from a specific area of the screen. 
